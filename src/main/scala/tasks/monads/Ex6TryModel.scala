...
/* Exercise 6: This module contains the implementation of a Try monad, which is a monad that
 * represents a computation that may fail. Try to follow these steps:
